...
{
    /// <inheritdoc />
    public partial class ReturnedOrders : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                CREATE OR ALTER VIEW [dbo].[vw_portal_widget_returned_orders] AS
                SELECT
                    ClientId = 652,
        ...
        {
           migrationBuilder.Sql(@"DROP VIEW [dbo].[vw_portal_widget_returned_orders];");
        }
    }
}
